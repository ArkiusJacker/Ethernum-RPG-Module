...
export const ETHERNUM_UI_ASSET_DEFINITIONS = Object.freeze([
  ...
  { id: "ETH-UI-13", path: `${ROOT}/accents/ornamental-divider.webp`, sourceFilename: "ETH-UI-13-ethernum-ornamental-divider.png", type: "accent", sourceWidth: 1565, sourceHeight: 165, runtimeWidth: 1024, runtimeHeight: 108, visual: { preferredWidth: 620, preferredHeight: 66, minWidth: 220, minHeight: 28, maxWidth: 1024, maxHeight: 108, opticalScale: 1, opacity: 0.86, fit: "contain", contentInset: { top: 12, right: 2, bottom: 12, left: 2 } } },
