...
Hooks.once("init", () => {
  ...
  loadTpls([
    ...
    `${ETHERNUM.TEMPLATE_PATH}sheets/ethernum/shell.html`,
    `${ETHERNUM.TEMPLATE_PATH}sheets/ethernum/header.html`,
    `${ETHERNUM.TEMPLATE_PATH}sheets/ethernum/navigation.html`,
